...
def segundo_recordatorio_clientes_interesados():
    try:
        ...
        for cliente in clientes_interesados:
            ...
            if diferencia_horas < 46 or diferencia_horas > 70:
                print(f"El cliente ID: {cliente_id} aún no lleva 46 horas desde su ultima interacion o ya le se ha dado un segundo recordatorio.")
                continue
            ...
            try:
                ...
                mensaje = (
                    f"Hola {nombre_cliente} 😊, nuevamente queremos recordarte que estamos disponibles para ayudarte. "
                    f"Si tienes alguna duda o consulta, no dudes en escribirnos. "
                    f"Estamos aquí para agendar tu cita o resolver cualquier inquietud. ¡Será un placer ayudarte! 🙌"
                )
                #print(mensaje)
                ...
                print(f"Error al dar el segundo recordatorio al cliente interesado {cliente_id}: {e}")
    except Exception as e:
        print(f"Error al procesar las clientes interesados para el segundo recordatorio: {e}")

if __name__ == "__main__":
    segundo_recordatorio_clientes_interesados()
